...
const ChatContainer = () => {
  ...
  const handleSendImage = async(e)=>{
    ...
    if(!file || !file.type.startsWith("image/")){
      // toast.error("select an image file") // Make sure to import toast if you want to use it
    ...
    reader.onloadend = async ()=>{
      ...
      e.target.value = "" // Fixed: removed extra space
    }

    reader.readAsDataURL(file); // Fixed: was "readerAsDataURL"
  }
  ...
  return selectedUser ? (
    <div className="relative h-full flex flex-col overflow-hidden">
      ...
      {/* Chat area - messages will go here */}
      <div className='flex flex-col flex-1 overflow-y-auto p-3 p-6 pb-20'>
