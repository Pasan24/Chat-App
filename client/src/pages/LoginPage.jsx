  ...
  return (
    ...
    <img src = {assets.logo_big} alt="" className=' w-[min(30vw,250px)]'/>
      ...
      {!isDataSubmitted && (
        ...
        required className='p-2 border  border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indego-500' /> 
      ...
      <div className='flex flex-col gap-2'>
        {currState==="Sign up" ?(
          <p className=" text-sm  text-gray-600 "> Already have an Account ? <span onClick={()=>{setCurrState("Login");
            setIsDataSubmitted(false) }} className='font-medium text-violet-500 cursor-pointer'>Login here</span></p>
        ):(
          <p className=" text-sm  text-gray-600" >Create an account . <span onClick={()=>setCurrState("Sign up")} className='font-medium
           text-violet-500 cursor-pointer'> Click Here</span></p>
        )}
